...
namespace mini {
	...
	public:
		 ...
		 * doesn't exist yet.
		 *********************************************************************/
		Window(HINSTANCE hInstance, int width, int height, IWindowMessageHandler* h = nullptr);
		 ...
		 * doesn't exist yet.
		 *********************************************************************/
		Window(HINSTANCE hInstance, int width, int height, const std::wstring& title, IWindowMessageHandler* h = nullptr);
